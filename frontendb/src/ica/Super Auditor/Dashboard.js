...
// function SuperAuditorDashboard() {
//     const { t } = useTranslation();
//     return (
//         <>
//             <div className= "main-screen">
//                 <div className='text-balance ml-2 my-1'> 
//                 <Sidebar
//                 menuItems={menuItems}
//                 />
//                 </div>
//                 <div className=' w-screen  bg-slate-700 rounded-2xl mx-2 my-1 p-6 overflow-y-auto'>

//                     <div className='text-white flex justify-between'>
//                         <h1 >{t("greeting")}</h1>
//                         <h1 > <LanguageSelector /></h1>
//                     </div>
//                     <h2 className='text-orange-500'>Welcome to Super Auditor</h2>
//                     <div className="flex flex-wrap justify-center gap-4 py-6 ">
 
//                         <div className="card border-blue-500">
//                             <h2 className="card-title text-blue-600">People</h2>
//                             <ul className="card-list">
//                                 <li>Total Staff: <span className="font-medium">120</span></li>
//                                 <li>Training Rate: <span className="font-medium">85%</span></li>
//                                 <li>Satisfaction: <span className="font-medium">90%</span></li>
//                             </ul>
//                         </div>

//                         <div className="card border-green-500">
//                             <h2 className="card-title text-green-600">Process</h2>
//                             <ul className="card-list">
//                                 <li>Total Staff: <span className="font-medium">120</span></li>
//                                 <li>Training Rate: <span className="font-medium">85%</span></li>
//                                 <li>Satisfaction: <span className="font-medium">90%</span></li>
...
//                             <h2 className="card-title text-purple-600">Tech</h2>
//                             <ul className="card-list">
//                                 <li>Total Staff: <span className="font-medium">120</span></li>
//                                 <li>Training Rate: <span className="font-medium">85%</span></li>
//                                 <li>Satisfaction: <span className="font-medium">90%</span></li>
...
//                             <h2 className="card-title text-orange-600">Governance</h2>
//                             <ul className="card-list">
//                                 <li>Total Staff: <span className="font-medium">120</span></li>
//                                 <li>Training Rate: <span className="font-medium">85%</span></li>
//                                 <li>Satisfaction: <span className="font-medium">90%</span></li>
...
//                             <h2 className="text-center text-xl font-bold my-6 text-white">
//                                 Supported Audit Standards
//                             </h2>
//                             <div className="flex gap-6 flex-wrap justify-around">

//                                 <div className="bg-white w-[220px] p-4 rounded-lg shadow text-center">
//                                     <img
//                                         src="/images/nabh.png"
//                                         alt="NABH"
...
// export default SuperAuditorDashboard
